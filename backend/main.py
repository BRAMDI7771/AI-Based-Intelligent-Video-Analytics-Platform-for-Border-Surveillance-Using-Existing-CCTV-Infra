...
# ============================================================
# WEBRTC VIDEO STREAM TRANSFORMER
# ============================================================
class VideoTransformTrack(MediaStreamTrack):
    kind = "video"

    def __init__(self, track, channel_container):
        super().__init__()
        self.track = track
    ...
    async def recv(self):
        ...
        # Send stats via WebRTC DataChannel if connected
        channel = self.channel_container.get("channel")
...
route = app.router.add_post('/offer', offer_handler)
cors.add(route)
